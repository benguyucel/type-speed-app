        ...
        <>
            <Modal footer={[
                ...
                <Content style={{ flexDirection: 'column' }}>
                    <Title style={{ color: 'green', textAlign: 'center' }}>{correctCount + incorrectCount} WPM  </Title>
                    <span style={{ textAlign: 'center' }}>(i can write word)</span>
                </Content>
                <Content>
                    <ContentSpan>Accuracy </ContentSpan>
                    <ContentSpan>{
                        (totalKeyStroke - incorrectCount) / (totalKeyStroke + Math.floor((editWordCount) / 2)) / 100}</ContentSpan>
                </Content>
                <Content>
